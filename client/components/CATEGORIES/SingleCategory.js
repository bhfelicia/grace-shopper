...
import {destroyCategory, fetchCategory} from '../../store/thunks/categoryThunk'
...
class SingleCategory extends Component{
    ...
    render(){
        const selectedCategory_products = this.props.categoryReducer.selectedCategory.products;
